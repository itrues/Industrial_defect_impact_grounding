...
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=1 --use_env  --master_port=29503 main.py \
    ...
    --output_dir ./results/logs_pretrained_EB3_multistep_masked_mvtec_anomaly_detection_ratio_8_seed_65_mixed_blurred_rerun
...
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=1 --use_env  --master_port=29503 main.py \
    ...
    --output_dir ./results/logs_pretrained_EB5_multistep_masked_mvtec_anomaly_detection_ratio_8_seed_65_mixed_blurred_rerun
    #--resume '/home/cike/workspace/github/fromgithub/mdetr/results/logs_pretrained_EB5_multistep_masked_ratio_8_seed_65_epoch_60_blured/BEST_checkpoint.pth'